...
armLiftValue = rospy.get_param("/arm_lift_value",-0.12)
...
#		rospy.logwarn("First point")
		for i in range(0,75,angle_step):
...
#		rospy.logwarn("Second point")		
		for i in range(75,0,-angle_step):
...
#		rospy.logwarn("Third point")
		for i in range(0,-15,-angle_step):
...
#		rospy.logwarn("Fourth point")
		for i in range(-15,0,angle_step):
